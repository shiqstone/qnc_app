...
import 'package:qnc_app/nbpuzzle/widgets/auto_size_text.dart';
import 'package:qnc_app/nbpuzzle/utils/time_format.dart';
import 'package:qnc_app/nbpuzzle/widgets/icons/stopwatch.dart';
...
class _GameStopwatchWidgetState extends State<GameStopwatchWidget> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final time = widget.time != 0 ? DateTime.now().millisecondsSinceEpoch - widget.time : 0;
